...
```bash
sonar analyze agentic --project fabien-martin-sonarsource_ship-it --depth DEEP --file <path/to/file1> --file <path/to/file2>
```
...
```bash
sonar analyze agentic --project fabien-martin-sonarsource_ship-it --depth DEEP
```
